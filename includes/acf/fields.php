...
if ( function_exists( 'acf_add_local_field_group' ) ):
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_5ed78a4639ee3',
				'label' => 'Disable Jit',
				'name' => 'disable_jit',
				'type' => 'true_false',
				'instructions' => 'If your generated pages are showing up empty, try enabling this setting, pressing "Update" and then running the post request again. If your pages still do not show up after this, please contact support.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_66e5a821013b0',
				'label' => 'Enable Drip-feeding',
				'name' => 'enable_dripfeeding',
				'type' => 'true_false',
				'instructions' => 'If enabled, you can limit the post building process to a maximum number of posts per day.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '50',
			...
			array(
				'key' => 'field_66e5a85f013b1',
				'label' => 'Posts Per Day',
				'name' => 'dripfeeding_posts_per_day',
				'type' => 'number',
				'instructions' => 'The amount of posts to drip-feed each day',
				'required' => 1,
				'conditional_logic' => array(
					array(
						array(
							'field' => 'field_66e5a821013b0',
							'operator' => '==',
							'value' => '1',
						),
					),
			...
			array(
				'key' => 'field_8ef23c984ab1',
				'label' => 'Create Neighborhood Pages',
				'name' => 'create_neighborhood_pages',
				'type' => 'true_false',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_8ef23c984ab2',
				'label' => 'Create Suburb Pages',
				'name' => 'create_suburb_pages',
				'type' => 'true_false',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_8ff41b8044an47',
				'label' => 'Create Index Pages',
				'name' => 'create_index_pages',
				'type' => 'true_false',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_8ff41b8044an1212',
				'label' => 'Create Pages Based On Population',
				'name' => 'create_base_on_population',
				'type' => 'true_false',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
