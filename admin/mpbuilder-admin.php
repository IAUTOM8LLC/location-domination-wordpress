...
class mpbuilder_admin {
	...
	public function render_admin_page() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/pages/mpbuilder-page.php';
	}

	public function render_setup_page() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/pages/mpbuilder-setup.php';
	}
...
//                $data = wp_remote_get( 'https://masspage.aen.technology/wp-json/mpbuilder/v1/get_selected_cities?offset='.$offset.'&limit='.$increment.'&filter='. implode( ",", $county_ids) );
				...
				//global $wpdb;
				//$results = new mpbuilder_api();
				//$results->get_selected_cities( $county_ids, $increment, $offset );
