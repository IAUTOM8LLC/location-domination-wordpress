            ...
            <div v-if="!isAccountConnected" role="alert" class="rounded-lg mb-12  warning bg-warning text-orange-700 p-4">
                <div class="flex p-4">
                    <div class="block ml-8 mt-2">
                        ...
                        <p class="mt-2">In order to access <strong>all</strong> of the features that we offer within this plugin, please connect your account.</p>
                        <p class="mt-5">
                            <router-link to="/account" class="fancy">Connect my account</router-link></p></div>
                </div>
            </div>
        ...
        <div class="rounded border border-gray-300 mx-auto bg-white flex" style="max-width: 1240px;">
            <div class="w-1/5 border-r border-gray-300">
                <router-link to="/dashboard">
                    <svg class="block mx-auto mt-8 mb-2" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" width="151.991" height="39.864"
                         viewBox="0 0 151.991 39.864">
                        <defs>
                            <radialGradient id="radial-gradient" cx="0.5" cy="0.5" r="0.394"
                            ...
                            <radialGradient id="radial-gradient-2" r="0.501" gradientTransform="translate(0.001)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-3" r="0.485"
                                            gradientTransform="translate(-0.033) scale(1.065 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-4" r="0.473"
                                            gradientTransform="translate(-0.061) scale(1.123 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-5" r="0.4"
                                            gradientTransform="translate(-0.444) scale(1.888 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-6" r="0.357"
                                            gradientTransform="translate(-2.926) scale(6.852 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-8" r="0.452"
                                            gradientTransform="translate(-0.129) scale(1.258 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-9" r="0.461"
                                            gradientTransform="translate(-0.099) scale(1.197 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-10" r="0.515"
                                            gradientTransform="translate(0.029) scale(0.943 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-12" r="0.452"
                                            gradientTransform="translate(-0.129) scale(1.259 1)"
                                            xlink:href="#radial-gradient"/>
                            <radialGradient id="radial-gradient-18" r="0.501" gradientTransform="translate(0.002)"
                                            xlink:href="#radial-gradient"/>
                        ...
                        <g id="svgexport-0" transform="translate(-274.727 -453.258)">
                            <path id="Path_1" data-name="Path 1" d="M317.752,229.1v-17.93h2.617V226.7H326.6v2.4Z"
                            ...
                            <path id="Path_6" data-name="Path 6" d="M480,229.1v-17.93h2.617V229.1Z"
                            ...
                            <g id="Group_2" data-name="Group 2" transform="translate(274.727 473.451)">
                                ...
                                <path id="Path_11" data-name="Path 11" d="M723.728,229.1v-17.93h2.617V229.1Z"
                                ...
                                <path id="Path_15" data-name="Path 15" d="M831.8,229.1v-17.93h2.617V229.1Z"
